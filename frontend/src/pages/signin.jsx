    ...
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <div className="text-center">
          <h2 className="text-3xl font-bold" style={{ color: '#f5e0b5', fontFamily: 'serif', textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>Welcome Back</h2>
          <p className="text-sm mt-1" style={{ color: '#c4b08a', textShadow: '0 1px 4px rgba(0,0,0,0.5)' }}>Sign in to continue your story</p>
        </div>
        ...
        <p className="text-center text-sm" style={{ color: '#c4b08a', textShadow: '0 1px 4px rgba(0,0,0,0.5)' }}>
          ...
          <Link to="/signup" className="hover:underline font-semibold" style={{ color: '#f5e0b5' }}>Sign up</Link>
        </p>
